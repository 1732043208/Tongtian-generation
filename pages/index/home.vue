	...
	<view class="content">
		...
		<Tabbar title="通天代" label="昨日累计服务 35896 人">
			<template v-slot:button>
				<button type="primary" class="tabbar-button" @click="pushReleaseOrder">
		...
		<!-- 轮播图模块 -->
		<swiper class="swiper" circular :indicator-dots="true" :autoplay="true" indicator-color="rgba(255,255,255)" indicator-active-color="rgba(240,235,234)">
...
export default defineComponent({
	...
	setup() {
		...
		// 发布订单按钮点击事件
		const pushReleaseOrder = () => {
			uni.navigateTo({
				url: '/pages/release-order/ReleaseOrder'
			});
		};
		return {
			...toRefs(data),
